...
const Homepage = () => {
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* Content Container */}
      <div className="relative z-20 container mx-auto py-24 md:py-28 px-6 flex flex-col items-center justify-center h-full">
        ...
        {/* Title */}
        <h1 className="text-4xl md:text-7xl font-bold mb-4 md:mb-6 text-white tracking-tight text-center">
          SpaceX Data Analysis
        </h1>

        {/* Subtitle */}
        <p className="text-lg md:text-2xl text-gray-300 mb-6 md:mb-12 max-w-2xl text-center">
